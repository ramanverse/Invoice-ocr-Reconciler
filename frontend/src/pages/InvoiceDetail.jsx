        ...
        <div className="slide-up" style={{ maxWidth: 860 }}>
            ...
            {editing ? (
                ...
                <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: 12, marginBottom: 24 }}>
                    ...
                    <Field label="Subtotal" value={invoice.subtotal ? `$${invoice.subtotal.toFixed(2)}` : null} icon={<DollarSign size={12} color="var(--accent-green)" />} />
                    <Field label="Tax" value={invoice.tax ? `$${invoice.tax.toFixed(2)}` : null} icon={<DollarSign size={12} color="var(--accent-yellow)" />} />
                    <Field label="Total Amount" value={invoice.total_amount ? `$${invoice.total_amount.toFixed(2)}` : null} icon={<DollarSign size={12} color="var(--accent-green)" />} />
                ...
                <div className="card mb-6" style={{
                    ...
                    <div style={{ fontSize: 14, display: 'grid', gap: 8 }}>
                        ...
                        {invoice.reconciliation.discrepancy > 0 && (
                            <div><span style={{ color: 'var(--text-muted)' }}>Discrepancy: </span><span style={{ color: 'var(--accent-red)', fontWeight: 600 }}>${invoice.reconciliation.discrepancy.toFixed(2)}</span></div>
                        )}
